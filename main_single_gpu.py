...
def get_arguments():
    ...
    parser.add_argument('-cfg', type=str, default='/home/ubuntu13/lsz/code/S-T-V2/PaddleViT/image_classification/SwinTransformerV2/configs/swinv2_base_patch4_window7_224.yaml')
    parser.add_argument('-dataset', type=str, default='imagenet2012')
    parser.add_argument('-batch_size', type=int, default=48)
    parser.add_argument('-image_size', type=int, default=None)
    parser.add_argument('-data_path', type=str, default='/home/ubuntu13/lsz/dataset/ILSVRC')
